            ...
            <div className="container">
                <div className="call-to-action">
                    <div className="section-heading heading-light">
                        ...
                        <Link href={"/contact"}  ><a className='text-decoration-none axil-btn btn-large btn-fill-white'>
                            Estimate Project</a>
                        </Link>
                    </div>
                    <div className="thumbnail">
                        ...
                        <ul className="list-unstyled small-thumb">
                            <li className="shape shape-1" data-sal="slide-right" data-sal-duration="800" data-sal-delay="400">
                                <img className="paralax-image" src="/images/others/cta-one.png"alt="Laptop" />
                            </li>
                            <li className="shape shape-2" data-sal="slide-left" data-sal-duration="800" data-sal-delay="300">
                                <img className="paralax-image" src="/images/others/cta-two.png" alt="Bill" />
                            </li>
                        </ul>
                    </div>
                </div>
