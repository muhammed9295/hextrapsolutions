...
import ProcesstData from "../../data/process/GraphicDesignProcess.json";
...
const GraphicDesignprocess = () => {
    return (
        ...
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle 
                subtitle="Process"
                title="Our Graphic Designing process"
                description="Our comprehensive Graphic design strategy ensures a perfectly crafted designs for your business."
                textAlignment=""
                textColor="mb--90"
            />
