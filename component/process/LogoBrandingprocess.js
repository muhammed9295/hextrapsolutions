...
import ProcesstData from "../../data/process/LogoBrandingProcess.json";
// import Tilty from 'react-tilty';

const getProcesstData = ProcesstData;

const LogoBrandingprocess = () => {
    return (
        
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle 
                subtitle="Process"
                title="Our Logo Design & Branding process"
...
export default LogoBrandingprocess;