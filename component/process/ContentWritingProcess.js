...
import ProcesstData from "../../data/process/ContentWriting.json";
...
const ContentWritingProcess = () => {
    return (
        ...
        <div className="section section-padding bg-color-light pb--70">
            <SectionTitle 
                subtitle="Process"
                title="Our Content Writing process"
                description="Our comprehensive Content Writing strategy ensures a perfectly crafted content for your business."
                textAlignment=""
                textColor="mb--90"
            />
