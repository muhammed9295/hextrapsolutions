...
import Digitalprocess from '../component/process/Digitalprocess';
...
export default function DigitalMarketing() {
  ...
  return (
    <>
    <Head>
        <title>Digital Marketing | Hextrap Solutions</title>
     ...
     <ColorSwitcher />
        <main className="main-wrapper">
            ...
            styleClass=""
            mainThumb="/images/banner/digital-marketing.png"
            />
            <AboutTwo />
