...
import ContentWritingProcess from '../component/process/ContentWritingProcess';
...
export default function ContentWriting() {
  ...
  return (
    <>
    <Head>
        <title>Content Writing | Hextrap Solutions</title>
     ...
     <ColorSwitcher />
        <main className="main-wrapper">
            ...
            styleClass=""
            mainThumb="/images/banner/content-writing.png"
            />
            <AboutTwo />
