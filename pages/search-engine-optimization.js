...
import Seoprocess from "../component/process/Seoprocess";
...
export default function SearchEngineOptimization() {
  ...
  return (
    <>
    <Head>
        <title>Search Engine Optimization - SEO | Hextrap Solutions</title>
        <meta
          name="description"
      ...
      <main className="main-wrapper">
        ...
        <BcrumbBannerOne
          ...
          styleClass=""
          mainThumb="/images/banner/search-engine-optimization.png"
        />
        <AboutTwo />
