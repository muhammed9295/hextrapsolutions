...
import PayperClickprocess from '../component/process/PayperClickprocess';
...
export default function PayperClick() {
  ...
  return (
    <>
    <Head>
        <title>Pay per Click | Hextrap Solutions</title>
        <meta
          name="description"
     ...
     <ColorSwitcher />
        <main className="main-wrapper">
            ...
            styleClass=""
            mainThumb="/images/banner/pay-per-click.png"
            />
            <AboutTwo />
