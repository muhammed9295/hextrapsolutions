...
import LogoBrandingprocess from "../component/process/LogoBrandingprocess";
...
export default function LogoAndBranding() {
  ...
  return (
    <>
    <Head>
        <title>Logo & Branding | Hextrap Solutions</title>
        <meta
          name="description"
      ...
      <main className="main-wrapper">
        ...
        <BcrumbBannerOne
          ...
          styleClass=""
          mainThumb="/images/banner/logo-and-branding.png"
        />
        <AboutTwo />
