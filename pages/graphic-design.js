...
import GraphicDesignprocess from "../component/process/GraphicDesignprocess";
...
export default function GraphicDesign() {
  ...
  return (
    <>
      <Head>
        <title>Graphic Design | Hextrap Solutions</title>
        <meta
          name="description"
      ...
      <main className="main-wrapper">
        ...
        <BcrumbBannerOne
          ...
          styleClass=""
          mainThumb="/images/banner/graphic-design.png"
        />
        <AboutTwo />
