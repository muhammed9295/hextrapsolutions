...
export default function termsAndConditions() {
  return (
    <>
    <Head>
        <title>Terms and Conditions | Hextrap Solutions</title>
        <meta
          name="description"
      ...
      <main className="main-wrapper">
        <HeaderOne />
        <BreadCrumbOne title="Terms & Conditions" page="Terms & Conditions" />
        <div className="section-padding privacy-policy-area">
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-10">
                <div className="privacy-policy-content">
                  <p>Welcome to hextrap!</p>

                  <p>
                    These terms and conditions outline the rules and regulations
                    for the use of Hextrap Solutions's Website, located at
                    https://hextrap.com/.
                  </p>

                  <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use hextrap if you do not
                  ...
                  <p>
                    We employ the use of cookies. By accessing hextrap, you
                    agreed to use cookies in agreement with the Hextrap
                  ...
                  <p>
                    Unless otherwise stated, Hextrap Solutions and/or its
                    licensors own the intellectual property rights for all
                    material on hextrap. All intellectual property rights are
                    reserved. You may access this from hextrap for your own
                  ...
                  <p>You must not:</p>
                  <ul>
                    <li>Republish material from hextrap</li>
                    <li>Sell, rent or sub-license material from hextrap</li>
                    <li>Reproduce, duplicate or copy material from hextrap</li>
                    <li>Redistribute content from hextrap</li>
                  </ul>

                  <p>
                    Parts of this website offer an opportunity for users to post
                    and exchange opinions and information in certain areas of
                    the website. Hextrap Solutions does not filter, edit,
                    publish or review Comments prior to their presence on the
                    website. Comments do not reflect the views and opinions of
                    Hextrap Solutions,its agents and/or affiliates. Comments
                    reflect the views and opinions of the person who post their
                    views and opinions. To the extent permitted by applicable
                    laws, Hextrap Solutions shall not be liable for the Comments
                  ...
                  <p>
                    Hextrap Solutions reserves the right to monitor all Comments
                  ...
                  <p>
                    You hereby grant Hextrap Solutions a non-exclusive license
                  ...
                  <p>
                    ...
                    compensates the absence of Hextrap Solutions; and (d) the
                  ...
                  <p>
                    ...
                    inform us by sending an e-mail to Hextrap Solutions. Please
                  ...
                  <p>
                    No use of Hextrap Solutions's logo or other artwork will be
