...
import WebProcess from "../component/process/Webprocess";
...
export default function WebsiteDesignAndDevelopment() {
  ...
  return (
    <>
    <Head>
        <title>Website Design & Development | Hextrap Solutions</title>
        <meta
          name="description"
      ...
      <main className="main-wrapper">
        ...
        <BcrumbBannerOne
          ...
          styleClass=""
          mainThumb="/images/banner/website-design-and-development.png"
        />
        <AboutTwo />
